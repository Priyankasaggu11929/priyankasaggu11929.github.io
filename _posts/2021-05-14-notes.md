---
layout: post
title: "`containerd` v1.5.1 GA, `watch` stream server-side timeout , dropping python2 support from `k8s-client/python` & `k8s-client/python-base`, dedicated kubernetes contribution page #11"
