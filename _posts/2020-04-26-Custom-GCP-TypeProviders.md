...
I chose to write all my templates using Jinja. Because Jinja templates are far more readable in this case (in comparision to Python templates). These are (an almost) clone of JSON configuration description of the resource (to be deployed).
